...
public class OTPActivity extends AppCompatActivity {
    ...
    private void sendOTP() {
        final String username="longnguyenhoang105@gmail.com";
        final String password="asdfghjkl138";
        String messageToSend="Mã OTP xác nhận QL Cham Cong:"+ randomOTP;
        ...
        try {
            ...
            message.setSubject("QL Cham Cong send OTP");
